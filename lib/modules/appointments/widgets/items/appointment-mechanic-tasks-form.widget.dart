...
class AppointmentMechanicTasksFormWidget extends StatelessWidget {
  Function confirmFunction;

  AppointmentMechanicTasksFormWidget({this.confirmFunction});
      ...
      content: new Container(
        ...
        child: new Stack(
          ...
          children: <Widget>[
            Container(
              child: Text(
                '${S.of(context).mechanic_appointment_tasks_form_title}',
