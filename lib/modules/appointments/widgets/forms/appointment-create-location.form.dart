...
class AppointmentCreateLocationForm extends StatefulWidget {
  AppointmentCreateLocationForm({Key key}) : super(key: key);

  @override
  _AppointmentCreateLocationFormState createState() {
    return _AppointmentCreateLocationFormState();
  }
}

class _AppointmentCreateLocationFormState
