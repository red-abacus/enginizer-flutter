...
class WorkEstimateAcceptServiceProvidersForm extends StatefulWidget {
  WorkEstimateAcceptServiceProvidersForm({Key key}) : super(key: key);

  @override
  WorkEstimateAcceptServiceProvidersFormState createState() {
    return WorkEstimateAcceptServiceProvidersFormState();
  }
}

class WorkEstimateAcceptServiceProvidersFormState
    extends State<WorkEstimateAcceptServiceProvidersForm> {
  ...
  _loadData() async {
    try {
      _provider.loadProviders().then((value) {
        setState(() {
          _isLoading = false;
        });
      });
        ...
        : new Container(
            ...
            child: new Container(
              ...
              child: new AlertInfoWidget(
                  S.of(context).estimator_accept_modal_step3_alert),
            ),
          );
  }
